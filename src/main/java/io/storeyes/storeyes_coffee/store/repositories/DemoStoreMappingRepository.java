...
public interface DemoStoreMappingRepository extends JpaRepository<DemoStoreMapping, Long> {
    ...
    @EntityGraph(attributePaths = {"alertsSourceStore", "kpiSourceStore", "stockSourceStore", "chargesSourceStore", "accessSourceStore", "feedbackSourceStore", "staffSourceStore"})
